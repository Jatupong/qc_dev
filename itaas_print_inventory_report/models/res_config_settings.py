...
class ResConfigSettings(models.TransientModel):
    ...
    internal_transfer_no_form = fields.Char(related='company_id.internal_transfer_no_form',
                                            string='Internal Transfer No. Form', readonly=False)
    ...
    product_delivery_note = fields.Char(related='company_id.product_delivery_note', string='ใบส่งมอบผลิตภัณฑ์',
                                        readonly=False)
    packing_list = fields.Char(related='company_id.packing_list', string='Packing List', readonly=False)
    product_delivery_note_number = fields.Char(related='company_id.product_delivery_note_number',
                                               string='เลขที่แก้ไขใบส่งมอบผลิตภัณฑ์',
                                               readonly=False)
