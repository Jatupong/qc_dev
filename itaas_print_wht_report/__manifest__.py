...
Stock report
    ...
    'data' : [
        ...
        'report/wht_pnd_item_report_53.xml',
        'wizard/report_pnd_wizard_view.xml',
        'report/font_pnd2_report.xml',
        'report/font_pnd3_report.xml',
        'report/font_pnd53_report.xml',
        'report/wht_pnd_3_entries_report_journal.xml',
        'report/wht_pnd_53_entries_report_journal.xml',
        'report/wht_pnd_3_item_report.xml',
        'report/wht_pnd_53_item_report.xml',
